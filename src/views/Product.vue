                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false">
                                    <div class="pt" @click="changePhotoDefault(thumbs[0])" :class="thumbs[0] == photoDefault ? 'active' : ''">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changePhotoDefault(thumbs[1])" :class="thumbs[1] == photoDefault ? 'active' : ''">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changePhotoDefault(thumbs[2])" :class="thumbs[2] == photoDefault ? 'active' : ''">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changePhotoDefault(thumbs[3])" :class="thumbs[3] == photoDefault ? 'active' : ''">
...
export default {
	name: 'Product',
	components: {carousel, RelatedProducts, Header, Footer},
	data() {
		return {
	...
	methods : {
		changePhotoDefault(src) {
			this.photoDefault = src;
		}
	}
}
</script>
